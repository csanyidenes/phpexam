      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            <img src="views/assets/images/featured.jpg" alt="">
            <a href="property-details.html"><img src="views/assets/images/featured-icon.png" alt="" style="max-width: 60px; padding: 0px;"></a>
          </div>
        </div>
        <div class="col-lg-5">
          <div class="section-heading">
            <h6>| Featured</h6>
            <h2>Best Appartment &amp; Sea views</h2>
          </div>
        ...
        <div class="col-lg-3">
          <div class="info-table">
            <ul>
              <li>
                <img src="views/assets/images/info-icon-01.png" alt="" style="max-width: 52px;">
                <h4>250 m2<br><span>Total Flat Space</span></h4>
              </li>
              <li>
                <img src="views/assets/images/info-icon-02.png" alt="" style="max-width: 52px;">
                <h4>Contract<br><span>Contract Ready</span></h4>
              </li>
              <li>
                <img src="views/assets/images/info-icon-03.png" alt="" style="max-width: 52px;">
                <h4>Payment<br><span>Payment Process</span></h4>
              </li>
              <li>
                <img src="views/assets/images/info-icon-04.png" alt="" style="max-width: 52px;">
      ...
      <div class="row">
        <div class="col-lg-4 offset-lg-4">
          <div class="section-heading text-center">
            <h6>| Video views</h6>
            <h2>Get Closer views & Different Feeling</h2>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-10 offset-lg-1">
          <div class="video-frame">
            <img src="views/assets/images/video-frame.jpg" alt="">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src="views/assets/images/deal-01.jpg" alt="">
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src="views/assets/images/deal-02.jpg" alt="">
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src="views/assets/images/deal-03.jpg" alt="">
                    </div>
                    <div class="col-lg-3">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="views/assets/images/property-01.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="views/assets/images/property-02.jpg" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$1.180.000</h6>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="views/assets/images/property-03.jpg" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$1.460.000</h6>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="views/assets/images/property-04.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="views/assets/images/property-05.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="views/assets/images/property-06.jpg" alt=""></a>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="item phone">
                <img src="views/assets/images/phone-icon.png" alt="" style="max-width: 52px;">
                <h6>010-020-0340<br><span>Phone Number</span></h6>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="item email">
                <img src="views/assets/images/email-icon.png" alt="" style="max-width: 52px;">
